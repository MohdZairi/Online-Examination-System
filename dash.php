...
{
  $name=$_SESSION['name'];
  echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,'.$name.' </span><a href="account.php" class="log log1"></a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}
?>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php"><b>Dashboard</b></a>
    </div>
...
if(@$_GET['q']==1) 
{
  ...
  $c=1;
    while($row = mysqli_fetch_array($result)) 
    {
      ...
      <td><a title="Delete User" href="update.php?email='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
    }
  $c=0;
  echo '</table></div></div>';
